...
const NewsletterSection: React.FC = () => {
  ...
  return (
    <section className="py-24 md:py-32 border-t" style={{ background: '#EAE0CC', borderColor: '#D9D1C0' }}>
      <div className="container mx-auto px-6 text-center max-w-3xl">
        ...
        <p className="text-lg font-light mb-10 leading-relaxed" style={{ color: '#798478' }}>
